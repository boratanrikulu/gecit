...
// NetworkServiceForInterface returns the network service name for a given
// hardware interface (e.g. en0 -> "Wi-Fi"), via networksetup -listallhardwareports.
// Ported from origin/main ccf1659.
...
// DetectActiveService finds the network service for the active internet
// interface by parsing `route -n get default`. Falls back to "Wi-Fi".
// Ported from origin/main ccf1659.
